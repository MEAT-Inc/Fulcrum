...
namespace FulcrumEncryption
{
    ...
    /// </summary>
    public static class FulcrumEncryptionKeys
    {
        ...
        private static bool _setEncryptionKey(byte[] EncryptionKey, KeyTypes KeyType)
        {
            ...
            if (EncryptionKey.Length != FulcrumEncryptor.KeyByteSize) {
                _encryptionKeyLogger.WriteLog($"ERROR! {KeyTypeString} KEY WAS {EncryptionKey.Length}! KEY SHOULD BE {FulcrumEncryptor.KeyByteSize} BYTES!", LogType.ErrorLog);
                return false;
            }
