...
namespace FulcrumInjector.FulcrumLogic
{
    ...
    /// </summary>
    public static class InjectorLogExports
    {
        // Logger object.
        ...
        private static bool ValidateFunctionRefs()
        {
            ...
            IntPtr LoadResult = FulcrumWin32Invokers.LoadLibrary(InjectorDllPath);
            ...
            try
            {
                ...
                IntPtr PassThruWriteACommand = FulcrumWin32Invokers.GetProcAddress(LoadResult, "PassThruWriteToLogA");
                ...
                IntPtr PassThruWriteWCommand = FulcrumWin32Invokers.GetProcAddress(LoadResult, "PassThruWriteToLogW");
                ...
                IntPtr PassThruSaveCommand = FulcrumWin32Invokers.GetProcAddress(LoadResult, "PassThruSaveLog");
