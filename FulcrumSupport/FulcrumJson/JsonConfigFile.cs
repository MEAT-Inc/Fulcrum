...
#else
            var FulcrumKey = Registry.LocalMachine.OpenSubKey(_injectorRegistryKey);
            if (FulcrumKey != null) { FulcrumInjectorExe = Path.GetDirectoryName(FulcrumKey.GetValue("InjectorExecutable").ToString()); } 
            else 
            {
